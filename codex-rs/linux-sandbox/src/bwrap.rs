...
use crate::metadata_paths::append_metadata_path_masks_for_writable_root;
use crate::metadata_paths::append_protected_create_targets_for_writable_root;
...
fn create_filesystem_args(
    ...
    for writable_root in &sorted_writable_roots {
        ...
        append_protected_create_targets_for_writable_root(
            &mut bwrap_args.protected_create_targets,
            &protected_metadata_names,
            root,
