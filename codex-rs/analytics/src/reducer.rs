        ...
        match notification {
            ServerNotification::ItemCompleted(notification) => {
                ...
                let Some(ResolvedAnalyticsContext {
                    ...
                    AnalyticsDropSite::tool_item(&notification, item_id),
                    AnalyticsConnectionSource::Thread(&notification.thread_id),
                    ThreadMetadataRequirement::Required(&notification.thread_id),
                )
                else {
                    return;
                };
...
fn item_or_observed_duration_ms(
    ...
    item_duration_ms.or_else(|| completed_at_ms.checked_sub(started_at_ms))
}
